...
copy /Y Release-32\Python%PYTH_MAJOR%.%PYTH_MINOR%Plugin.dll ..\PythonPlugins-32
...
if %errorlevel% neq 0 exit /b %errorlevel%
copy /Y Release-32\Python%PYTH_MAJOR%.%PYTH_MINOR%Plugin.dll ..\PythonPlugins-64
...
if %errorlevel% neq 0 exit /b %errorlevel%
copy /Y Release-64\Python%PYTH_MAJOR%.%PYTH_MINOR%Plugin.dll ..\PythonPlugins-64
